...
namespace OnlineTickets.Server.Migrations
{
    ...
    [Migration("20231217235142_AddQty")]
            ...
            modelBuilder.Entity("OnlineTickets.Shared.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CinemaId = 1,
                            CinemaName = "Blokbaster",
                            EndDate = new DateTime(2023, 12, 25, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5793),
                            ...
                            Qty = 0,
                            SelectedDate = new DateTime(2023, 12, 18, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5726),
                            StartDate = new DateTime(2023, 12, 18, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5792)
                        },
                        new
                        {
                            MovieId = 2,
                            CinemaId = 2,
                            CinemaName = "Cinema Citi",
                            EndDate = new DateTime(2023, 12, 28, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5804),
                            ...
                            Qty = 0,
                            SelectedDate = new DateTime(2023, 12, 18, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5800),
                            StartDate = new DateTime(2023, 12, 21, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5803)
                        },
                        new
                        {
                            MovieId = 3,
                            CinemaId = 3,
                            CinemaName = "Butterfly Cinema",
                            EndDate = new DateTime(2024, 1, 1, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5810),
                            ...
                            Qty = 0,
                            SelectedDate = new DateTime(2023, 12, 18, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5806),
                            StartDate = new DateTime(2023, 12, 25, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5808)
                        },
                        new
                        {
                            MovieId = 4,
                            CinemaId = 1,
                            CinemaName = "Blokbaster",
                            EndDate = new DateTime(2023, 12, 27, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5815),
                            MovieCategory = "Drama",
                            ...
                            Qty = 0,
                            SelectedDate = new DateTime(2023, 12, 18, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5811),
                            StartDate = new DateTime(2023, 12, 20, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5814)
                        },
                        new
                        {
                            MovieId = 5,
                            CinemaId = 2,
                            CinemaName = "Cinema Citi",
                            EndDate = new DateTime(2023, 12, 25, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5819),
                            ...
                            Qty = 0,
                            SelectedDate = new DateTime(2023, 12, 18, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5816),
                            StartDate = new DateTime(2023, 12, 18, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5819)
                        },
                        new
                        {
                            MovieId = 6,
                            CinemaId = 3,
                            CinemaName = "Butterfly Cinema",
                            EndDate = new DateTime(2023, 12, 26, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5825),
                            MovieCategory = "Comedy",
                            ...
                            Qty = 0,
                            SelectedDate = new DateTime(2023, 12, 18, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5822),
                            StartDate = new DateTime(2023, 12, 19, 1, 51, 42, 527, DateTimeKind.Local).AddTicks(5824)
                        });
                });
