...
namespace OnlineTickets.Server.Migrations
{
    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "MovieId", "CinemaId", "CinemaName", "EndDate", "MovieCategory", "MovieDescription", "MovieImageUrl", "MovieName", "PlaceName", "Price", "ProducerId", "ProducerName", "Qty", "Reserved", "SelectedDate", "StartDate", "Status" },
                values: new object[,]
                {
                    { 1, 1, "Blokbaster", new DateTime(2023, 12, 28, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4215), "Cartoon", "The plot follows the Grinch and his pet dog Max who plan to stop Whoville's Christmas celebration by stealing all the town's decorations and gifts.", "https://upload.wikimedia.org/wikipedia/en/4/4f/The_Grinch%2C_final_poster.jpg", "The Grinch", "", 20m, 6, "Chris Meledandri", 0, 0, new DateTime(2023, 12, 21, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4155), new DateTime(2023, 12, 21, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4214), "Available" },
                    { 2, 2, "Cinema Citi", new DateTime(2023, 12, 31, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4226), "Family", "James looks back at the last Christmas he and Bob spent scraping a living on the streets and how Bob helped him through one of his toughest times – providing strength, friendship and inspiration – and ultimately teaching each other about the true meaning of Christmas spirit along the way.", "https://upload.wikimedia.org/wikipedia/en/thumb/4/4b/Christmas_gift_from_bob_ver2.jpg/330px-Christmas_gift_from_bob_ver2.jpg", "A Gift from Bob", "", 25m, 5, "Charles Martin Smith", 0, 0, new DateTime(2023, 12, 21, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4222), new DateTime(2023, 12, 24, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4225), "Available" },
                    { 3, 3, "Butterfly Cinema", new DateTime(2024, 1, 4, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4256), "Romance", "Katarina \"Kate\" Andrich, a young aspiring singer, bounces around between her friends’ places, and has a dead-end job as an elf at a year-round Christmas shop in Central London, whose strict but good-hearted Chinese owner calls herself \"Santa\". Whilst at work, she notices a man outside staring upward and strikes up a conversation, learning that his name is Tom Webster and his oft-repeated life wisdom is to \"look up\" for things that others seldom observe.", "https://upload.wikimedia.org/wikipedia/en/0/0c/Last_Christmas_poster.jpeg", "Last Christmas", "", 22m, 4, "Paul Feig", 0, 0, new DateTime(2023, 12, 21, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4251), new DateTime(2023, 12, 28, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4255), "Available" },
                    { 4, 1, "Blokbaster", new DateTime(2023, 12, 30, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4261), "Drama", "Based on the 2005 biography American Prometheus by Kai Bird and Martin J. Sherwin, the film chronicles the career of Oppenheimer, with the story predominantly focusing on his studies, his direction of the Manhattan Project during World War II, and his eventual fall from grace due to his 1954 security hearing.", "https://upload.wikimedia.org/wikipedia/en/4/4a/Oppenheimer_%28film%29.jpg", "Oppenheimer", "", 28m, 3, "Christopher Nolan", 0, 0, new DateTime(2023, 12, 21, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4257), new DateTime(2023, 12, 23, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4259), "Available" },
                    { 5, 2, "Cinema Citi", new DateTime(2023, 12, 28, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4265), "Comedy", "Based on the eponymous fashion dolls by Mattel, it is the first live-action Barbie film after numerous computer-animated films and specials.", "https://upload.wikimedia.org/wikipedia/en/0/0b/Barbie_2023_poster.jpg", "Barbie", "", 24m, 2, "Greta Gerwig", 0, 0, new DateTime(2023, 12, 21, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4262), new DateTime(2023, 12, 21, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4264), "Available" },
                    { 6, 3, "Butterfly Cinema", new DateTime(2023, 12, 29, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4271), "Comedy", "Italian-American brothers Mario and Luigi have recently opened a plumbing business in Brooklyn, to the derision of their ex-employer Spike and the disapproval of their father. After seeing a significant water main leak on the news, Mario and Luigi go underground to fix it but are sucked into a Warp Pipe and separated.", "https://upload.wikimedia.org/wikipedia/en/4/44/The_Super_Mario_Bros._Movie_poster.jpg", "The Super Mario Bros. Movie", "", 27m, 1, "Aaron Horvath", 0, 0, new DateTime(2023, 12, 21, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4267), new DateTime(2023, 12, 22, 14, 58, 48, 343, DateTimeKind.Local).AddTicks(4270), "Available" }
                });
